...
<body>
    ...
    <div class="content">
        <div class="nav">
            <ul>
                <li class="current"><a href="#">buyer behavior</a></li>
        ...
        <div class="container">
            <div class="title">buyer behavior</div>
            <div class="show">
         ...
         series : [
             {
                 ...
                 center: ['50%', '50%'],
                 data:[
                	 {value:<%=list.get(0)[1]%>, name:'special focus'},
                     {value:<%=list.get(1)[1]%>, name:'buy'},
                     {value:<%=list.get(2)[1]%>, name:'add to cart'},
                     {value:<%=list.get(3)[1]%>, name:'click'},
